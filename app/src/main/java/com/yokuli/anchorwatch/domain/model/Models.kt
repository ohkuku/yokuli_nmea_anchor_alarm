...
data class BackdownAnchorEstimate(val latitude:Double,val longitude:Double,val distanceMeters:Double,val uncertaintyRadiusMeters:Double,val confidence:Confidence,val sampleCount:Int)
