...
/** Vessel HDT/HDG is a current heading-aligned Phone measurement, never a
 * cached unaligned handset compass value. Trip attitude mounting is an
 * independent coordinate frame used only by ROT/heel/pitch. */
object PhoneVesselHeadingPublicationPolicy {
    ...
    fun evaluate(
        ...
        @Suppress("UNUSED_PARAMETER") runtimeMountState:PhoneVesselMountState,
        nowElapsed:Long,
        ...
        return HeadingPublicationEligibility(true,"CURRENT_ALIGNED_PHONE_VESSEL_HEADING")
    }
}
