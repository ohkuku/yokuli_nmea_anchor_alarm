...
class AnchorWatchRuntime(
    ...
    suspend fun arm(request:ArmRequest){
        ...
        val waitingForGps=positionSource!=GpsDataSource.DEMO&&!acceptedReadiness.ready
